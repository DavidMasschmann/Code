...
public class Conta {
    ...
    public static void verSaldo (ArrayList<Conta> contas) {
        String u = Teclado.lerString("Digite sua senha: ");
        j = 0;
        do {
    ...
    public static void verExtrato(ArrayList<Conta> contas) {
        String pass = Teclado.lerString("Digite sua senha: ");
        j = 0;
        do {
    ...
    public static void mostrar() {
        for (int j = 0; j < Main.contas.size(); j++) {
            System.out.println("Número da conta: " + Main.contas.get(j).nConta +
